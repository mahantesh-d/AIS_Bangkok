...
cd $target_directory
scp -P 64422 -oStrictHostKeyChecking=no 172.31.247.10:~/presto-server-0.162.tar.gz .
...
cd $target_directory
scp -P 64422 -oStrictHostKeyChecking=no 172.31.247.10:~/presto-cli-0.162-executable.jar .
